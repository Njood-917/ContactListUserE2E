...
// update contact
    ...
    public void setTheUrlForUpdateContact() {
        spec.pathParams("first", "contacts","second","66366c0c2e101a0013feadb0");
    }
...
//        System.out.println("expectedData = " + expectedData);
    ...
    public void setTheUrlForRead() {
        spec.pathParams("first", "contacts","second","6636706b0a93760013f0d197");
    ...
    public void setTheUrlForDeleteContact() {
        spec.pathParams("first", "contacts","second","66366fdc2e101a0013feadbe");
